...
function [IM_unwrapped, rowref, colref]=FloodFill(IM_phase, branch_cuts, IM_mask, handles)

[r_dim, c_dim]=size(IM_phase);
imagesc(immultiply(IM_phase, ~branch_cuts))
set(handles.StatusBox, 'String', 'Select a point of known phase'); drawnow
[xref,yref] = ginput(1); 
...
set(handles.StatusBox, 'String', 'Performing floodfill operation ...');drawnow;
tic;
count_limit=0;
adjoin_stuck=0;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
set(handles.StatusBox, 'String', 'Filling in branch cuts that border on unwrapped pixels ...'); drawnow
adjoin=zeros(r_dim, c_dim);                                 
...
t=toc;
set(handles.StatusBox, 'String', ['Floodfill operation completed in ',int2str(t),' second(s).']); drawnow
